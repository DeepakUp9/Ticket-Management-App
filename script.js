...
function openTicketModal(e){
  ...
  let tikcetTextDiv = ticketModal.querySelector(".ticket-text");
  tikcetTextDiv.addEventListener("keypress",handleKeyPress);
...
function handleKeyPress(e){
    ...
    if(e.key == "Enter" && isTextTyped && e.target.textContent!=""){
       ...
       let filterSelected =document.querySelector(".selected-filter").classList[1];
         ...
         let ticketInfoObject = {ticketFilters:filterSelected,ticketValue:e.target.textContent,ticketId:ticketId}
